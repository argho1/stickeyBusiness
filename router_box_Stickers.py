...
try:
    ...
    val1 = df[column_name_1].tolist()
    val2 = df[column_name_2].tolist()
...
def create_stickers(data1, data2, data3, barcodes):
    ...
    for page in range(num_pages):
        ...
        for idx, barcode_idx in enumerate(range(start_idx, end_idx)):
            ...
            rcno = Code128(val1[barcode_idx], writer=ImageWriter())
            ...
            macid = Code128(val2[barcode_idx], writer=ImageWriter())
